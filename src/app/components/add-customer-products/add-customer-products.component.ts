...
@Component({
  selector: 'app-add-customer-products',
  templateUrl: './add-customer-products.component.html',
  styleUrls: ['./add-customer-products.component.css']
})
export class AddCustomerProductsComponent implements OnInit, OnChanges {
